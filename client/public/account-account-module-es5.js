...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["account-account-module"], {
  ...
  function srcAppAccountAccountModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    AccountModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _account_routing_module__WEBPACK_IMPORTED_MODULE_2__["AccountRoutingModule"], _auth_auth_module__WEBPACK_IMPORTED_MODULE_3__["AuthModule"]]]
    });
  ...
  function srcAppAccountAuthAuthModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _angular_common_http__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! @angular/common/http */
    "./node_modules/@angular/common/__ivy_ngcc__/fesm2015/http.js"); // Forms
    // Components
    ...
    AuthModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _auth_routing__WEBPACK_IMPORTED_MODULE_2__["AuthRoutingModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"]]]
    });
  ...
  function srcAppAccountAuthLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_core_services_auth_auth_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    ...
    "./src/app/core/services/firestore/firestore.service.ts"); // Libs
    // Services


    var LoginComponent = /*#__PURE__*/function () {
      function LoginComponent(fb, router, cookieService, authService, firestoreService) {
      ...
      _createClass(LoginComponent, [{
        ...
        value: function handleLogin() {
          ...
          this.authService.login(this.email, this.password).then(function (user) {
            ...
            _this.handleCookieAsigned(_this.email);
          })["catch"](function (error) {
            _this.errorAlert('Error Login', error.message);
          });
        }
      }, {
        key: "handleCookieAsigned",
        value: function handleCookieAsigned(email) {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    console.log(email);
                    _context.next = 4;
                    return this.firestoreService.getUser(email).then(function (info) {
                      info.docs.map(function (doc) {
                        ...
                        if (userData.status === 1) {
                          if (userData.login === 0) {
                            ...
                            _this2.handleAssginedCookies(userData);
                          } else {
                            _this2.handleAssginedCookies(userData);
                          }
                        } else {
                          _this2.handleFirebaselogout();

                          _this2.userDisable();

                          _this2.loginButton = false;
                        }
                      });
                    });
        ...
        key: "handleAssginedCookies",
        value: function handleAssginedCookies(userData) {
        ...
        key: "errorAlert",
        value: function errorAlert(title, body) {
          var _this3 = this;

          sweetalert2__WEBPACK_IMPORTED_MODULE_5___default.a.fire(title, body, 'error').then(function (resp) {
            _this3.loginButton = false;
          });
        }
      }, {
        key: "handleFirebaselogout",
        value: function handleFirebaselogout() {}
      }]);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](LoginComponent, [{
        ...
        return [{
          ...
          type: src_app_core_services_auth_auth_service__WEBPACK_IMPORTED_MODULE_6__["AuthService"]
        }, {
